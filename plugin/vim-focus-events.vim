...
augroup TermFocusEvent
  ...
  if g:term_sync_clipboard
    au FocusGained * call s:CopyReg(g:term_clipreg_system, g:term_clipreg_noname, g:term_clipreg_backup)
    au FocusLost   * call s:CopyReg(g:term_clipreg_noname, g:term_clipreg_system)
  endif
